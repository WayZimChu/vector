 ...
 * will result in an exception or undefined behavior. Calls to |GMSAutocompleteFetcherDelegate|
 * methods will also called on the main thread. This method is non-blocking.
